...
- **[SKILLS.md](SKILLS.md)** — Load this into your MCP client's system prompt or agent config. It teaches the LLM how to use all 52 packs, retry transient errors, chain sessions, and file bug reports when it finds real issues.

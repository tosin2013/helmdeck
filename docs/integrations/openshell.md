...
| **Tool orchestration** (pack execution, MCP server, AI gateway, vault, artifact store) | **helmdeck** | 39 packs across 11 families; Docker-container session isolation; AES-256-GCM vault |
...
| **Tool availability** | 39 packs via MCP | Bring your own | 39 packs inside policy-governed sandboxes |

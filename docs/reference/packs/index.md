...
For a quick-lookup summary across all 57 packs (just the input/output contract), see **[`PACKS.md`](/PACKS)**. For agent-facing prompt guidance, see **[`SKILLS.md`](/integrations/SKILLS)**. This per-pack reference is the deep view.
